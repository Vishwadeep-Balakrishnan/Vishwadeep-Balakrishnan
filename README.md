...
I am an undergrad majoring in CS & Math, and I'm into AI Research, applied physics, and writing cool software.
...
> 🛠️ **Projects** — `RL based Robotic Swarm Coordination` , `RouteLab: a Python library for API mocking `, `phantom: a distributed in-memory KV store in C`, `LDPC Error Correction Simulator`
